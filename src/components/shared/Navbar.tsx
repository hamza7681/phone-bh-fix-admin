...
const ImageNoSSR = dynamic(() => import("@/components/shared/ImageRender"), {
  ssr: false,
});
  ...
  return (
    <div className="flex w-full">
      ...
      <div
        ...
        } z-10 bg-white block lg:hidden border-r-[1px] h-screen fixed overflow-auto top-0 lg:sticky lg:top-0 border-r-gray-200 transition-all duration-200`}
      >
        <div
      ...
      <div
        ...
        } z-10 bg-white hidden lg:flex border-r-[1px] h-screen sticky overflow-auto top-0 lg:top-0 border-r-gray-200 transition-all duration-200`}
      >
        <SideBarContent
          setCollapsed1={setCollapsed1}
          collapsed1={collapsed1}
